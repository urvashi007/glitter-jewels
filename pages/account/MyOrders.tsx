      ...
      <Stack spacing={2}>
        {orders.map((order) => (
          <Box
            ...
            alignItems="center"
          >
            <Box width={80} height={80} flexShrink={0} position="relative">
              <Image
                src={order.image}
                alt={order.id}
                width={80}
            ...
            <Box flex={1} ml={2}>
              ...
              <Typography variant="body2" mt={0.5}>
                Metal Type: {order.metalType} • Metal Color:{" "}
                <span
                  style={{
                    color:
                ...
                • Dia. Quality: {order.diaQuality}
              </Typography>
              <Typography variant="body2" mt={0.5}>
                Quantity: 1 •{" "}
                <span style={{ color: order.statusColor }}>{order.status}</span>
              </Typography>
              <Typography fontWeight="600" fontSize="18px" mt={1}>
                {order.price}
              </Typography>
            </Box>
